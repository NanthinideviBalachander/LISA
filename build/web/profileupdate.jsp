                                         ...
                                         <div class="form-group">
                                            <div class="maxl">
                                                <label class="radio inline"> 
                                                    <input type="radio" name="gender" value="male" checked  <c:if test="${gender=='Male'}">checked</c:if>>
                                                    <span> Male </span> 
                                                </label>
                                                <label class="radio inline"> 
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                         ...
                                         <div class="form-group">
                                            <div class="maxl">
                                                <label class="radio inline"> 
                                                    <input type="radio" name="mats" value="Single" checked  <c:if test="${mstatus=='Single'}">checked</c:if>>
                                                    <span> Single </span> 
                                                </label>
                                                <label class="radio inline"> 
                                                    <input type="radio" name="mats" value="Married" <c:if test="${mstatus=='Married'}">checked</c:if>>
                                                    <span>Married</span> 
                                                </label>
                                            </div>
                                        </div>
...
//    
                                         ...
                                         <input type="submit" class="btnRegister" id="upd" value="Update"/>
